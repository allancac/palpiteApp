      ...
      {!successRes &&
        <div>
          ...
          <div className='flex justify-start my-6 md:w-600 mx-auto' >
            ...
            <input className='bg-blue-100 rounded-md h-6 w-full py-4 px-6 text-lg font-sans' name='Whatsapp' value={form.Whatsapp} type="tel" id='userWhatsapp ' pattern='[0-9]{2} [0-9]{5}-[0-9]{4}' required placeholder='Digite seu número de Whatsapp' onChange={mudarState} />
          </div>
